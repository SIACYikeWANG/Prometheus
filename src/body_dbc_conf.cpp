...
volatile const DbcParserSignalTblType TBL_DP_CAN1_112_SIGNALLIST[] =
{
    ...
    {(AddrType)&EPS_SteeringAngleReq_112_CAN1, DP_SIGNALTYPE_FLOAT, 8, 16,  DP_BYTEORDER_MOTOROLA,    1,     0, -500, 500, DP_SIGNTYPE_UNSIGNED}
};
...
{
    {(AddrType)&EPS_SteeringAngle_202_CAN1, DP_SIGNALTYPE_FLOAT, 8, 16, DP_BYTEORDER_MOTOROLA, 0.06, -1937, -480, 480, DP_SIGNTYPE_UNSIGNED}
};
