...
volatile const DbcParserSignalTblType TBL_DP_CAN1_240_SIGNALLIST[] =
{
    ...
    {(AddrType)&Intel_Sig2_CAN1, DP_SIGNALTYPE_FLOAT,  8,   4, DP_BYTEORDER_INTEL, 1,    -8,    -8,    7, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Intel_Sig3_CAN1, DP_SIGNALTYPE_FLOAT, 12,  12, DP_BYTEORDER_INTEL, 1, -2048, -2048, 2047, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Intel_Sig4_CAN1, DP_SIGNALTYPE_FLOAT, 24,  12, DP_BYTEORDER_INTEL, 1, -2048, -2048, 2047, DP_SIGNTYPE_UNSIGNED},
...
{
    {(AddrType)&Moto_Sig1_CAN1, DP_SIGNALTYPE_FLOAT,  7,   8, DP_BYTEORDER_MOTOROLA, 1,  -128,  -128,  127, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig2_CAN1, DP_SIGNALTYPE_FLOAT, 23, 12, DP_BYTEORDER_MOTOROLA, 1, -2048, -2048, 2047, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig3_CAN1, DP_SIGNALTYPE_FLOAT, 31, 12, DP_BYTEORDER_MOTOROLA, 1, -2048, -2048, 2047, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig4_CAN1, DP_SIGNALTYPE_FLOAT, 35,  4, DP_BYTEORDER_MOTOROLA, 1,    -8,    -8,    7, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig5_CAN1, DP_SIGNALTYPE_FLOAT, 37,  2, DP_BYTEORDER_MOTOROLA, 1,    -2,    -2,    1, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig6_CAN1, DP_SIGNALTYPE_FLOAT, 39,  2, DP_BYTEORDER_MOTOROLA, 1,    -2,    -2,    1, DP_SIGNTYPE_UNSIGNED},
    {(AddrType)&Moto_Sig7_CAN1, DP_SIGNALTYPE_FLOAT, 55,  8, DP_BYTEORDER_MOTOROLA, 1,  -128,  -128,  127, DP_SIGNTYPE_UNSIGNED},
